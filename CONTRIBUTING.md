...
1. [File an issue](https://github.com/plabayo/geopaint.app/issues/new/choose).
...
3. Clone the repo: `git clone https://github.com/plabayo/geopaint.app`
4. Change into the checked out source: `cd geopaint.app`
5. Fork the repo.
6. Set your fork as a remote: `git remote add fork git@github.com:GITHUB_USERNAME/geopaint.app.git`
